...
using namespace std;
#ifndef interfacepaolah   // if x.h hasn't been included yet...
#define interfacepaolah  //   #define this so the compiler knows it has been included

class InterfacePaola{
    public:
    InterfacePaola(list<Route>*, map<bool, queue<Message> >*, char*, char*, char*, char*, int, char*, int);
